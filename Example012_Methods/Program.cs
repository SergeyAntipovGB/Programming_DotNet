...
// Вид 2. Метод который ничего не возвращает
// void Method2(string msg)
// {
//     Console.WriteLine(msg);
// }
// Method2(msg: "Текст сообщения"); // в метод передается именованый аргумент
...
// Вид 3. Метод который ничего не принимает но возвращает значение
// int Method3()
// {
...
// Вид 4. Метод который принимает и возвращает значение
